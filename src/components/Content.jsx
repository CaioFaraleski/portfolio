            ...
            <motion.div
              ...
              {page === 0 ? (
                <div className="h-full flex flex-col ml-10 mt-10">
                  ...
                  >
                    Resume
                    <img src="https://caiofaraleski.github.io/portfolio/src/assets/images/download.png" className="downimg filter group-hover:brightness-0 group-hover:invert h-7 ml-5 group-hover:delay-500" />
                  </a>
                </div>
              ) : null}
              {page === 1 ? (
